 ...
 */
Trix.Watchdog.Serializer = class Serializer {
  constructor(element) {
  ...
  serializeSelection() {
    ...
    const startId = this.ids.get(range != null ? range.startContainer : undefined);
    const endId = this.ids.get(range != null ? range.endContainer : undefined);
