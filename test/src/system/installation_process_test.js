...
testGroup("Installation process", {template: "editor_html"}, function() {
  test("element.editorController", () => assert.ok(getEditorController() instanceof Trix.EditorController));
  ...
  return test("sets value property", done =>
    defer(function() {
...
testGroup("Installation process without specified elements", {template: "editor_empty"}, () =>
  test("creates identified toolbar and input elements", function(done) {
